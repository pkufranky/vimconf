...
if !exists('s:doneMappings')
	...
	call IMAP ('`>', '\ge', "tex")
	call IMAP ('`,', '\nonumber', "tex")
	" call IMAP ('`~', '\tilde{ä}«»', "tex")
	call IMAP ('`~', '\tilde{ä}', "tex")
	" call IMAP ('`;', '\dot{ä}«»', "tex")
	call IMAP ('`;', '\dot{ä}', "tex")
	" call IMAP ('`:', '\ddot{ä}«»', "tex")
	call IMAP ('`:', '\ddot{ä}', "tex")
	" call IMAP ('`2', '\sqrt{ä}«»', "tex")
	call IMAP ('`2', '\sqrt{ä}', "tex")
    call IMAP ('`|', '\Big|', "tex")
	" call IMAP ('`I', "\\int_{ä}^{«»}«»", 'tex')
	call IMAP ('`I', "\\int_{ä}^{}", 'tex')
	" }}}
	" latex environments (my style) originally in imaps.vim {{{
	call IMAP ("bar".s:ml, "\\leftä\<cr>\\begin{array}{«dimension»}\<cr>«elements»\<cr>\\end{array}\<cr>\\right«»", "tex")
	call IMAP ("ben".s:ml, "\\begin{enumerate}\<cr>\\item ä\<cr>\\end{enumerate}«»", "tex")
	call IMAP ("bit".s:ml, "\\begin{itemize}\<cr>\\item ä\<cr>\\end{itemize}«»", "tex")
	call IMAP ("beq".s:ml, "\\begin{equation}\<cr>\\label{ä}\<cr>\\end{equation}«»", "tex")
	call IMAP ("bqn".s:ml, "\\begin{eqnarray}\<cr>ä\<cr>\\end{eqnarray}«»", "tex")
	...
	call IMAP ("bfe".s:ml, "\\begin{figure}\<cr>\\vspace{ä}\<cr>\\caption{«caption text»}\<cr>\\end{figure}«»", "tex")
	call IMAP ("btb".s:ml, "\\begin{tabular}{ä}\<cr>\<cr>\\end{tabular}«»", "tex")
	call IMAP ("bta".s:ml, "\\begin{table}\<cr>\\centering\<cr>\\caption{tab:ä}\<cr>\\begin{tabular}{«dimensions»}\<cr>\<cr>\\end{tabular}\<cr>\\label{tab:«label»}\<cr>\\end{table}«»", "tex")
	call IMAP ("pic".s:ml, "\\begin{picture}(4,4)\<cr>\\put(0.5,0){\\framebox(4,4){ä}}\<cr>\\end{picture}«»", "tex")
	call IMAP ("mat".s:ml, "\\left[\<cr>\\begin{array}{ä}\<cr>«»\<cr>\\end{array}\<cr>\\right]«»", "tex")
	call IMAP ("verb".s:ml, "\\begin{verbatim}\<cr>\<cr>ä\\end{verbatim}«»", "tex")
	call IMAP ("minip".s:ml, "\\begin{minipage}[t]{äcm}\<cr>\\end{minipage}«»", "tex")
	" end my style latex environments }}}
	" latex environments from Mikolaj Machowski {{{
	function! <SID>TeX_imap_env(shortcut,env)
		" exe 'call IMAP ("'.a:shortcut.'",  "\\begin{'.a:env.'}\<cr>ä\<cr>\\end{'.a:env.'}«»", "tex")'
		exe 'call IMAP ("'.a:shortcut.'",  "\\begin{'.a:env.'}\<cr>ä\<cr>\\end{'.a:env.'}", "tex")'
	endfunction
